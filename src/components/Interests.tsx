        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {interestsData.map((interest, index) => (
            <motion.div
              ...
              className="interest-card group rounded-2xl border /50 border-zinc-800/80 /80 bg-zinc-900/40 backdrop-blur-sm p-8 text-center shadow-lg hover:shadow-yellow-500/10 transition-shadow duration-500"
